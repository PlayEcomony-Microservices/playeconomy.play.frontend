...
window.USERS_API_URL = `${window.IDENTITY_SERVICE_URL}/api/users`
window.TRADING_SERVICE_URL = "https://localhost:5007";
window.PURCHASE_API_URL = `${window.TRADING_SERVICE_URL}/api/purchase`;
window.STORE_API_URL = `${window.TRADING_SERVICE_URL}/api/store`;
